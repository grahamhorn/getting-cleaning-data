...
# Code Book
The experiment design is summarized in the README.txt file in the zip file. See that file for further information.


## Variables
The following description is taken from the features_info.txt file contained in the zip file.
...
* activity - takes one of 6 values: WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITTING, STANDING, LAYING
* subject - numbers from 1 to 30 denoting an experiment participant
...
Only the measurements on the mean and standard deviation for each measurement have been kept.

The subject and activity labels were added as additional columns. The activity coding was replaced by the labels provided in the zip file.

The script also produces a second tidy data set with the average of each variable for each activity and each subject.
